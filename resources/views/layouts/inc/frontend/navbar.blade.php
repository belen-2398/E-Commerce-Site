                    ...
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/cart') }}">
                                <span class="iconify" data-icon="mdi:cart-outline" style="vertical-align: middle;"></span> Cart (<livewire:frontend.cart.cart-count />)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('wishlist') }}">
                                <span class="iconify" data-icon="mdi:heart-outline" style="vertical-align: middle;"></span> Wishlist (<livewire:frontend.wishlist-count />)
                            </a>
                        </li>
                        @guest
                        @if (Route::has('login'))
