            ...
            <div class="row">
                ...
                <div class="col-md-7 mt-3">
                    <div class="product-view">
                        ...
                        <div>
                            @if ($product->productColors->count() > 0)
                                ...
                                <div>
                                    ...
                                    <label for="" class="btn-sm py-1 mt-2 text-white bg-danger">Out of Stock</label>
                                @elseif($this->prodColorSelectedQuantity > 0)
                                    <label for="" class="btn-sm py-1 mt-2 text-white bg-success">In Stock</label>    
                                @endif
                                </div>
                        ...
                        <div class="mt-2">
                            <button type="button" wire:click="addToCart({{ $product->id }})" class="btn btn1"> <i class="fa fa-shopping-cart"></i> Add To Cart
                            </button>
