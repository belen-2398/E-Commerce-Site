                                    ...
                                    <div class="col-md-12 mb-3" wire:ignore>
                                        ...
                                        <div class="d-md-flex align-items-start">
                                            <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <button class="nav-link fw-bold active" wire:loading.attr="disabled"  id="cashOnDeliveryTab-tab" data-bs-toggle="pill" data-bs-target="#cashOnDeliveryTab" type="button" role="tab" aria-controls="cashOnDeliveryTab" aria-selected="true">Cash on Delivery</button>
...
{{-- paypal --}}
@push('scripts') 
    <script src=""> //copia de pag de paypal  </script>
    <script src=""> //copia de pag de paypal  </script>
@endpush
